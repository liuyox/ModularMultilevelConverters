...
void InitXintf(void)
{
	// This shows how to write to the XINTF registers.  The
	    ...
	    EALLOW;
	    XintfRegs.XINTCNF2.bit.XTIMCLK = 1;//1
	    // No write buffering
	    XintfRegs.XINTCNF2.bit.WRBUFF = 0;//0
	    // XCLKOUT is enabled
	    XintfRegs.XINTCNF2.bit.CLKOFF = 0;//0
	    // XCLKOUT = XTIMCLK/2
	    XintfRegs.XINTCNF2.bit.CLKMODE = 1;//1
	    ...
	    XintfRegs.XTIMING0.bit.XWRACTIVE = 3;//3
	    XintfRegs.XTIMING0.bit.XWRTRAIL = 1;//1
	    // Zone read timing
	    XintfRegs.XTIMING0.bit.XRDLEAD = 1;//1
	    XintfRegs.XTIMING0.bit.XRDACTIVE = 3;//3
	    XintfRegs.XTIMING0.bit.XRDTRAIL = 1;//1

	    // double all Zone read/write lead/active/trail timing
	    XintfRegs.XTIMING0.bit.X2TIMING = 0; //0

	    // Zone will sample XREADY signal
	//    XintfRegs.XTIMING0.bit.USEREADY = 1;
	//    XintfRegs.XTIMING0.bit.READYMODE = 1;  // sample asynchronous

	    // Zone will ignore XREADY signal
	    XintfRegs.XTIMING0.bit.USEREADY = 0;//0

	    // Size must be either:
	    // 0,1 = x32 or
	    // 1,1 = x16 other values are reserved
	    XintfRegs.XTIMING0.bit.XSIZE = 3;//3
